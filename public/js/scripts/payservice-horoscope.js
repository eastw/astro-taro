$(document).ready(function(){
	...
	$('#submit').click(function(){
		...
		var bday = $('#hour option:selected').val();
		var text = $('#hour').prev().find('div.text').text();
		$('#hour option').each(function(){
			if($(this).text() == text){
				formData['hour'] = $(this).val();
			}
		});
		
		var bday = $('#minute option:selected').val();
		var text = $('#minute').prev().find('div.text').text();
		$('#minute option').each(function(){
			if($(this).text() == text){
				formData['minute'] = $(this).val();
			}
		});
