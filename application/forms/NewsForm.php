<?php
class Application_Form_NewsForm extends Zend_Form{
	...
	public function init(){
		...
		$this->setDecorators(array(
				'PrepareElements',
				array('ViewScript', array('viewScript' => 'partials/news-form.phtml')),
		));
		...
		*/
		...
		$cancel->setAttrib('onclick','window.location.href="/admin/news"');
