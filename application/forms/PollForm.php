<?php
class Application_Form_PollForm extends Zend_Form{
	...
	public function init(){
		...
		$this->setDecorators(array(
				'PrepareElements',
				array('ViewScript', array('viewScript' => 'partials/poll-form.phtml')),
		));
		...
		$name->setLabel('Название голосования')
				->addFilter('StripTags')
		...
		$cancel->setAttrib('onclick','window.location.href="/admin/poll"');
