...
class Application_Form_ArticleForm extends Zend_Form{
	...
	public function init(){
		...
		$showInList = new Zend_Form_Element_Select('show_in_list');
		$showInList->setLabel('Показывать в общем списке')
			->setDecorators($decorators)
			->setMultiOptions(array(
					'y' => 'Показывать',
					'n' => 'Не показывать',
		...
		*/
		...
		$cancel->setAttrib('onclick','window.location.href="/admin/article"');
		...
		*/
		$this->addElements(array($title,$image,$imgNote,$anonse,$content,$activity,$showInList,$keywords,$desc,$tagslist,$addtag,$tagsplace,$submit, $cancel,$page/*,$tags*/));
