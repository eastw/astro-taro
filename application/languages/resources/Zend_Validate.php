...
return array(
    ...
    "Value is required and can't be empty" => " Это поле должно быть заполнено",
	...
	//Zend_captcha
	"Empty captcha value" => "Не ведены символы с картинки",
	"Captcha ID field is missing" => "Отсутствует ID поле",
	"Captcha value is wrong" => "Неверно введены символы с картинки",
